...
const styles = StyleSheet.create({
  ...
  summaryBack: { fontSize: 18, fontWeight: '700', color: '#5B4B8A', paddingHorizontal: 2 },
  summaryTextWrap: { flex: 1, minWidth: 0 },
  summaryTitle: { fontSize: 14, fontWeight: '800' },
  summaryMeta: { fontSize: 12, color: '#9B8EC4', marginTop: 1 },
  ...
  tinyLabel: { fontSize: 9, color: '#9B8EC4', fontWeight: '700', marginBottom: 1 },
  guestsBox: {
    borderWidth: 1,
    borderRadius: 8,
    paddingHorizontal: 6,
  ...
  toolDivider: { width: 1, height: 18, backgroundColor: '#E8E0FF' },
  toolIcon: { fontSize: 13, color: '#5B4B8A' },
  toolText: { fontSize: 13, fontWeight: '700' },
  toolChevron: { fontSize: 9, color: '#9B8EC4', marginLeft: 2 },
  toolDot: {
    width: 7,
    height: 7,
    borderRadius: 4,
  ...
  sheetTitle: { fontSize: 20, fontWeight: '800', color: '#2D1B4E', marginBottom: 8 },
  radioRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  radioLabel: { flex: 1, fontSize: 15, color: '#2D1B4E', paddingRight: 12 },
  radioOuter: {
    width: 22,
    height: 22,
    borderRadius: 11,
  ...
  radioOuterOn: { borderColor: '#6C5CE7' },
  radioInner: {
    width: 12,
    height: 12,
    borderRadius: 6,
  ...
  checkLabel: { flex: 1, fontSize: 15, color: '#2D1B4E', paddingRight: 12 },
  checkbox: {
    width: 22,
    height: 22,
    borderRadius: 4,
  ...
  chipText: { fontSize: 12, fontWeight: '700', color: '#2D1B4E' },
